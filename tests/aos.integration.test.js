...
describe('AOS Integration Tests — Real-world HTML patterns', () => {
	...
	it('staggered: 3 elements with increasing data-aos-delay', () => {
		const el1 = createAOSElement({ 'data-aos': 'fade-up', 'data-aos-delay': '0' });
		const el2 = createAOSElement({ 'data-aos': 'fade-up', 'data-aos-delay': '100' });
		const el3 = createAOSElement({ 'data-aos': 'fade-up', 'data-aos-delay': '200' });
	...
	it('disable removes data-aos attributes from elements', () => {
		const el = createAOSElement({ 'data-aos': 'fade', 'data-aos-duration': '500' });
		init();
