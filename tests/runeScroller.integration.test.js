...
describe("runeScroller Integration Tests", () => {
  ...
  beforeEach(() => {
    ...
    document.body.style.cssText =
      "width: 1024px; height: 2000px; margin: 0; padding: 0;";
  ...
  describe("Sentinel Wrapping & Structure", () => {
    it("places sentinel as sibling in flex parent", () => {
      ...
      // Element should still be directly in flex container
      expect(item.parentElement).toBe(flexContainer);
      // Sentinel should be a next sibling
      const sentinel = item.nextElementSibling;
  ...
  describe("Multiple Animations", () => {
    it("handles multiple animated elements independently", () => {
      ...
      const act1 = runeScroller(el1, {
        animation: "fade-in",
        sentinelId: "sent1",
      });
      const act2 = runeScroller(el2, {
        animation: "zoom-in",
        sentinelId: "sent2",
      });
      const act3 = runeScroller(el3, {
        animation: "flip",
        sentinelId: "sent3",
      });
  ...
  describe("Edge Cases", () => {
    it("handles element with complex parent structure", () => {
      ...
      // Element should have position:relative set directly
