...
import {
  ...
  disconnectObserver,
} from "../src/lib/observer-utils.js";
...
describe("Observer Utilities", () => {
  ...
  describe("createManagedObserver", () => {
    it("creates IntersectionObserver instance", () => {
      result = createManagedObserver(testElement, () => {}, { threshold: 0.5 });
    ...
    it("handles rootMargin option", () => {
      ...
      result = createManagedObserver(testElement, () => {}, { rootMargin });
    ...
    it("handles root option", () => {
      ...
      result = createManagedObserver(testElement, () => {}, { root });
